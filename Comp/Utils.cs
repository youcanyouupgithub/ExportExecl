...
namespace Comp
{
    ...
    public static class Utils
    {
        ...
        public static string ShowPage(int DataSourceCount, int PageSize, int CurrentPage, int Nums, string LinkPage)
        {
            ...
            PageStr.Append("<li class=\"pagego\">跳至<input type=\"text\" class=\"g-input\" id=\"pageindex\" size=\"5\" value=\"" + (CurrentPage + 1).ToString() + "\">页<input type=\"button\" class=\"g-btn\" onclick=\"window.location.href='" + LinkPage + "?pageindex='+$('#pageindex').val()+'" + QueryStr.ToString() + "'\" value=\"GO\"></input></li>");
            PageStr.Append("</ul>");
